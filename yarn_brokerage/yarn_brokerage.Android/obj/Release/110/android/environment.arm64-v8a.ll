...
@__DSOCacheEntry_name.2 = internal constant [16 x i8] c"libSkiaSharp.so\00", align 1
...
@assembly_store_bundled_assemblies = local_unnamed_addr global [54 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 8
